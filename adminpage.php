...
<body>
    <?php
        ...
        $level = $_SESSION["Userlevel"] = $data["position"];
        $ID = $_SESSION["UserID"] = $data["ID"];
        ...
        echo '<a href="editForm.php?ID='.$ID.'&level='.$level.'">🖋️แก้ไขโปรไฟล์    </a> <br /><br />';
        echo '<b><a href="viewuserlist.php?position=' . $_SESSION["Userlevel"] . '&ID='.$ID.'">📰ดูข้อมูลผู้ใช้ในระบบ</a></b><br /><br />';
        echo 'Username ที่กรอก &nbsp;&nbsp; :  &nbsp;&nbsp;',$username,'<br /><br />';
        echo 'Password ที่กรอก &nbsp;&nbsp; :  &nbsp;&nbsp;',$password,'<br /><br /><br />';
        echo '<b>(ดึงมาจาก Database)</b><br /><br />';
        echo '<b>User ID &nbsp;&nbsp; : </b> &nbsp;&nbsp;',($_SESSION['UserID']),'<br /><br />';
        echo '<b>User &nbsp;&nbsp; : </b> &nbsp;&nbsp;',($_SESSION['Username']),'<br /><br />';
        ...
        echo '<a href="login.html">🔚ออกจากระบบ</a>';
        echo '</form>';
